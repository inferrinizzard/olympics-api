...
import type { GamesDetailRow, GamesEmblemMap } from '../models/gamesData';
import type { SportDetailRow, SportsIconMap } from '../models/sportsData';
...
export class ImageDataService {
  ...
  public getCountryFlags = (): Promise<CountryFlagMap> =>
    db
      .any(
        `SELECT country, flag FROM ${this.countryDetailTable} ORDER BY country;`
      )
