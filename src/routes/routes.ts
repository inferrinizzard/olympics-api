...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/countries',
            ...
            function CountryDataController_getAllCountries(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/countries/:country',
            ...
            function CountryDataController_getCountry(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/games',
            ...
            function GamesDataController_getAllGames(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/games/:game',
            ...
            function GamesDataController_getGames(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/images/countries',
            ...(fetchMiddlewares<RequestHandler>(ImageDataController)),
            ...(fetchMiddlewares<RequestHandler>(ImageDataController.prototype.getCountryFlags)),

            function ImageDataController_getCountryFlags(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new ImageDataController();


              const promise = controller.getCountryFlags.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/images/games',
            ...(fetchMiddlewares<RequestHandler>(ImageDataController)),
            ...(fetchMiddlewares<RequestHandler>(ImageDataController.prototype.getGamesEmblems)),

            function ImageDataController_getGamesEmblems(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getGamesEmblems.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/images/sports',
            ...(fetchMiddlewares<RequestHandler>(ImageDataController)),
            ...(fetchMiddlewares<RequestHandler>(ImageDataController.prototype.getSportsLogos)),

            function ImageDataController_getSportsLogos(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getSportsLogos.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/medals',
            ...(fetchMiddlewares<RequestHandler>(MedalsDataController)),
            ...(fetchMiddlewares<RequestHandler>(MedalsDataController.prototype.getAllTotals)),

            function MedalsDataController_getAllTotals(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new MedalsDataController();


              const promise = controller.getAllTotals.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/medals/countries/:country',
            ...(fetchMiddlewares<RequestHandler>(MedalsDataController)),
            ...(fetchMiddlewares<RequestHandler>(MedalsDataController.prototype.getMedals)),

            function MedalsDataController_getMedals(request: any, response: any, next: any) {
            const args = {
                    country: {"in":"path","name":"country","required":true,"ref":"CountryId"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/medals/games/:game',
            ...(fetchMiddlewares<RequestHandler>(MedalsDataController)),
            ...(fetchMiddlewares<RequestHandler>(MedalsDataController.prototype.getGamesMedals)),

            function MedalsDataController_getGamesMedals(request: any, response: any, next: any) {
            const args = {
                    game: {"in":"path","name":"game","required":true,"ref":"GamesId"},
            };
            ...
            try {
              ...
              const promise = controller.getGamesMedals.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
